...
![Version](https://img.shields.io/static/v1?label=Version&message=0.12.6&color=informational&style=flat-square) <!-- x-release-please-version -->
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
![AppVersion](https://img.shields.io/static/v1?label=AppVersion&message=0.12.6&color=informational&style=flat-square) <!-- x-release-please-version -->
...
| uninstall.image | string | `"registry.k8s.io/kubectl:v1.37.1"` | Image for the uninstall hook Job (needs only `kubectl`). |
